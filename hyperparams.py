...
AlexNet_hyperparams = {
    ...
    "conv2_conv_kernel": tf.Variable(tf.glorot_uniform_initializer()((2, 2, 6, 8)), name="conv2_conv_kernel"),
    
    # 3rd Conv Layer block
    "conv3_conv_kernel": tf.Variable(tf.glorot_uniform_initializer()((2, 2, 8, 4)), name="conv3_conv_kernel"),
}
